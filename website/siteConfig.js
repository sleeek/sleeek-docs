...
const users = [
  {
    ...
    infoLink: 'https://sleeek.io',
    pinned: true,
  },
];

const siteConfig = {
  title: 'Sleeek Docs', // Title for your website.
  tagline: 'Documents for Sleeek',
  url: 'https://help.sleeek.io', // Your website URL
  ...
  projectName: 'sleeek-docs',
  organizationName: 'Sleeek',
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Sleeek Corporation`,
